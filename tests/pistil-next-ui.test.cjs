...
code+=';globalThis.__t={pistilStaleTag, pistilStale,pistilReceivedAt,buildPistilRows,buildPistilPosRows,pistilToWire,pistilFromWire,pistilPosToWire,pistilPosFromWire,pistilStockLabel,pistilUnitsLabel,pistilInventoryCell,baPistilByKey,baPistilPosByKey,setup(files){Object.assign(FILES,files);PISTIL=buildPistilRows();PISTIL_POS=buildPistilPosRows();}};';
...
T.setup({pistil:{data:[{...meta,Store:'Example','Product':'Unknown menu','In stock':'','Menu Counts':''},{...meta,Store:'Example','Product':'Available','In stock':'yes','Menu Counts':'5'}]},pistil_pos:{data:[{...meta,Store:'Example','Product':'Unknown POS','Units on hand':'','Avg units per day':'','Days on hand':''},{...meta,Store:'Example','Product':'Sold out','Units on hand':'0','Avg units per day':'0','Days on hand':'0'}]}});
...
T.setup({pistil:{data:[{...meta,Store:'Example','Report received at':''}]}});
